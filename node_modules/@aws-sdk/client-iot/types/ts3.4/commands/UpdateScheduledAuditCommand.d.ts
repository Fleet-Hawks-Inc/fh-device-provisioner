...
export declare type UpdateScheduledAuditCommandInput = UpdateScheduledAuditRequest;
export declare type UpdateScheduledAuditCommandOutput = UpdateScheduledAuditResponse & __MetadataBearer;
/**
