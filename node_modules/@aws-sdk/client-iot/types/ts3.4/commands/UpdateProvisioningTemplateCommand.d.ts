...
export declare type UpdateProvisioningTemplateCommandInput = UpdateProvisioningTemplateRequest;
export declare type UpdateProvisioningTemplateCommandOutput = UpdateProvisioningTemplateResponse & __MetadataBearer;
/**
