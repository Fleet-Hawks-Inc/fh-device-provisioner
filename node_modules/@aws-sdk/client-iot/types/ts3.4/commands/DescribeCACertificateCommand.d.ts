...
export declare type DescribeCACertificateCommandInput = DescribeCACertificateRequest;
export declare type DescribeCACertificateCommandOutput = DescribeCACertificateResponse & __MetadataBearer;
/**
