...
export declare type ListActiveViolationsCommandInput = ListActiveViolationsRequest;
export declare type ListActiveViolationsCommandOutput = ListActiveViolationsResponse & __MetadataBearer;
/**
