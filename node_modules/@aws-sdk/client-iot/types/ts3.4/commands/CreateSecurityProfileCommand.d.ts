...
export declare type CreateSecurityProfileCommandInput = CreateSecurityProfileRequest;
export declare type CreateSecurityProfileCommandOutput = CreateSecurityProfileResponse & __MetadataBearer;
/**
