...
export declare type ListScheduledAuditsCommandInput = ListScheduledAuditsRequest;
export declare type ListScheduledAuditsCommandOutput = ListScheduledAuditsResponse & __MetadataBearer;
/**
