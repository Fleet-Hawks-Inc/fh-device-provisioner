...
export declare type ListSecurityProfilesCommandInput = ListSecurityProfilesRequest;
export declare type ListSecurityProfilesCommandOutput = ListSecurityProfilesResponse & __MetadataBearer;
/**
