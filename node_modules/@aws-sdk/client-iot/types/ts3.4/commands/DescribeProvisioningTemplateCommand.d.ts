...
export declare type DescribeProvisioningTemplateCommandInput = DescribeProvisioningTemplateRequest;
export declare type DescribeProvisioningTemplateCommandOutput = DescribeProvisioningTemplateResponse & __MetadataBearer;
/**
