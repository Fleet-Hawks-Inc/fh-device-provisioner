...
export declare type DescribeRoleAliasCommandInput = DescribeRoleAliasRequest;
export declare type DescribeRoleAliasCommandOutput = DescribeRoleAliasResponse & __MetadataBearer;
/**
