...
export declare type CreateThingGroupCommandInput = CreateThingGroupRequest;
export declare type CreateThingGroupCommandOutput = CreateThingGroupResponse & __MetadataBearer;
/**
