...
export declare type CreateOTAUpdateCommandInput = CreateOTAUpdateRequest;
export declare type CreateOTAUpdateCommandOutput = CreateOTAUpdateResponse & __MetadataBearer;
/**
