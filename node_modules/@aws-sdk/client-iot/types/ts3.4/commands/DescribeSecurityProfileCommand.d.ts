...
export declare type DescribeSecurityProfileCommandInput = DescribeSecurityProfileRequest;
export declare type DescribeSecurityProfileCommandOutput = DescribeSecurityProfileResponse & __MetadataBearer;
/**
