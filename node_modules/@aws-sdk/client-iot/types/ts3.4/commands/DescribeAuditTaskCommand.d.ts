...
export declare type DescribeAuditTaskCommandInput = DescribeAuditTaskRequest;
export declare type DescribeAuditTaskCommandOutput = DescribeAuditTaskResponse & __MetadataBearer;
/**
