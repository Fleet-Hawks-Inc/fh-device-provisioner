...
export declare type DeleteProvisioningTemplateVersionCommandInput = DeleteProvisioningTemplateVersionRequest;
export declare type DeleteProvisioningTemplateVersionCommandOutput = DeleteProvisioningTemplateVersionResponse & __MetadataBearer;
/**
