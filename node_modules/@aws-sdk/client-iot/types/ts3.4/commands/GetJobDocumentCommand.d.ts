...
export declare type GetJobDocumentCommandInput = GetJobDocumentRequest;
export declare type GetJobDocumentCommandOutput = GetJobDocumentResponse & __MetadataBearer;
/**
