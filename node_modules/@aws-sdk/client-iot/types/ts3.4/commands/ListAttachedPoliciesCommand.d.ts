...
export declare type ListAttachedPoliciesCommandInput = ListAttachedPoliciesRequest;
export declare type ListAttachedPoliciesCommandOutput = ListAttachedPoliciesResponse & __MetadataBearer;
/**
