...
export declare type ListRoleAliasesCommandInput = ListRoleAliasesRequest;
export declare type ListRoleAliasesCommandOutput = ListRoleAliasesResponse & __MetadataBearer;
/**
