...
export declare type DeleteScheduledAuditCommandInput = DeleteScheduledAuditRequest;
export declare type DeleteScheduledAuditCommandOutput = DeleteScheduledAuditResponse & __MetadataBearer;
/**
