...
export declare type DeleteThingTypeCommandInput = DeleteThingTypeRequest;
export declare type DeleteThingTypeCommandOutput = DeleteThingTypeResponse & __MetadataBearer;
/**
