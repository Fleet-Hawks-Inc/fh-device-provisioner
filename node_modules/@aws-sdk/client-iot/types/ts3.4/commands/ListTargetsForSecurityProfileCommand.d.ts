...
export declare type ListTargetsForSecurityProfileCommandInput = ListTargetsForSecurityProfileRequest;
export declare type ListTargetsForSecurityProfileCommandOutput = ListTargetsForSecurityProfileResponse & __MetadataBearer;
/**
