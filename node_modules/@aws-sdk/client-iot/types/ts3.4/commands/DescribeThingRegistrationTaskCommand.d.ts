...
export declare type DescribeThingRegistrationTaskCommandInput = DescribeThingRegistrationTaskRequest;
export declare type DescribeThingRegistrationTaskCommandOutput = DescribeThingRegistrationTaskResponse & __MetadataBearer;
/**
