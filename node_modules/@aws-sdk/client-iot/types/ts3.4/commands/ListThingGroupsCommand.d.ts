...
export declare type ListThingGroupsCommandInput = ListThingGroupsRequest;
export declare type ListThingGroupsCommandOutput = ListThingGroupsResponse & __MetadataBearer;
/**
