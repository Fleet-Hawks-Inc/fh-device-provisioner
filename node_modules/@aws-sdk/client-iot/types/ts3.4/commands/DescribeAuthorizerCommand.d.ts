...
export declare type DescribeAuthorizerCommandInput = DescribeAuthorizerRequest;
export declare type DescribeAuthorizerCommandOutput = DescribeAuthorizerResponse & __MetadataBearer;
/**
