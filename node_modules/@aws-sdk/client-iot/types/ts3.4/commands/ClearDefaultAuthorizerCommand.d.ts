...
export declare type ClearDefaultAuthorizerCommandInput = ClearDefaultAuthorizerRequest;
export declare type ClearDefaultAuthorizerCommandOutput = ClearDefaultAuthorizerResponse & __MetadataBearer;
/**
