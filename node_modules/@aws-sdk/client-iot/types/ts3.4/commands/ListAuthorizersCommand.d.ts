...
export declare type ListAuthorizersCommandInput = ListAuthorizersRequest;
export declare type ListAuthorizersCommandOutput = ListAuthorizersResponse & __MetadataBearer;
/**
