...
export declare type AddThingToBillingGroupCommandInput = AddThingToBillingGroupRequest;
export declare type AddThingToBillingGroupCommandOutput = AddThingToBillingGroupResponse & __MetadataBearer;
/**
