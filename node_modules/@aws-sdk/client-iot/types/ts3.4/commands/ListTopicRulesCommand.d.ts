...
export declare type ListTopicRulesCommandInput = ListTopicRulesRequest;
export declare type ListTopicRulesCommandOutput = ListTopicRulesResponse & __MetadataBearer;
/**
