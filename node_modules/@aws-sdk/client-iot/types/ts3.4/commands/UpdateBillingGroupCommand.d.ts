...
export declare type UpdateBillingGroupCommandInput = UpdateBillingGroupRequest;
export declare type UpdateBillingGroupCommandOutput = UpdateBillingGroupResponse & __MetadataBearer;
/**
