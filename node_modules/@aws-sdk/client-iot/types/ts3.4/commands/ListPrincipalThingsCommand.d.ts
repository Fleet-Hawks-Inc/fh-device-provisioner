...
export declare type ListPrincipalThingsCommandInput = ListPrincipalThingsRequest;
export declare type ListPrincipalThingsCommandOutput = ListPrincipalThingsResponse & __MetadataBearer;
/**
