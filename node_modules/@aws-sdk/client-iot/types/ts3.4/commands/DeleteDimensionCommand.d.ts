...
export declare type DeleteDimensionCommandInput = DeleteDimensionRequest;
export declare type DeleteDimensionCommandOutput = DeleteDimensionResponse & __MetadataBearer;
/**
