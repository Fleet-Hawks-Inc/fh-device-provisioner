...
export declare type DeleteProvisioningTemplateCommandInput = DeleteProvisioningTemplateRequest;
export declare type DeleteProvisioningTemplateCommandOutput = DeleteProvisioningTemplateResponse & __MetadataBearer;
/**
