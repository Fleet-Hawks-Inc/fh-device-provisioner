...
export declare type UpdateRoleAliasCommandInput = UpdateRoleAliasRequest;
export declare type UpdateRoleAliasCommandOutput = UpdateRoleAliasResponse & __MetadataBearer;
/**
