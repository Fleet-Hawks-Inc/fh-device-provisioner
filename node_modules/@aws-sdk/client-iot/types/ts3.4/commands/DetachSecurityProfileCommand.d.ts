...
export declare type DetachSecurityProfileCommandInput = DetachSecurityProfileRequest;
export declare type DetachSecurityProfileCommandOutput = DetachSecurityProfileResponse & __MetadataBearer;
/**
