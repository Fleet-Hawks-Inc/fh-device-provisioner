...
export declare type DeleteAuthorizerCommandInput = DeleteAuthorizerRequest;
export declare type DeleteAuthorizerCommandOutput = DeleteAuthorizerResponse & __MetadataBearer;
/**
