...
export declare type DeleteBillingGroupCommandInput = DeleteBillingGroupRequest;
export declare type DeleteBillingGroupCommandOutput = DeleteBillingGroupResponse & __MetadataBearer;
/**
