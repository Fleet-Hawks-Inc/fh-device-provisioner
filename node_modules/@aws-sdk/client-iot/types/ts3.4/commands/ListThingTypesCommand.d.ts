...
export declare type ListThingTypesCommandInput = ListThingTypesRequest;
export declare type ListThingTypesCommandOutput = ListThingTypesResponse & __MetadataBearer;
/**
