...
export declare type DeleteRegistrationCodeCommandInput = DeleteRegistrationCodeRequest;
export declare type DeleteRegistrationCodeCommandOutput = DeleteRegistrationCodeResponse & __MetadataBearer;
/**
