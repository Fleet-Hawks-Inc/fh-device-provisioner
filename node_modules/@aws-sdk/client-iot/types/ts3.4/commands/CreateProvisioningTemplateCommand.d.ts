...
export declare type CreateProvisioningTemplateCommandInput = CreateProvisioningTemplateRequest;
export declare type CreateProvisioningTemplateCommandOutput = CreateProvisioningTemplateResponse & __MetadataBearer;
/**
