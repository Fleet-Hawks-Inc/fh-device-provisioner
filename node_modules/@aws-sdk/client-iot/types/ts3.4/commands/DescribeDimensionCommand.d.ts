...
export declare type DescribeDimensionCommandInput = DescribeDimensionRequest;
export declare type DescribeDimensionCommandOutput = DescribeDimensionResponse & __MetadataBearer;
/**
