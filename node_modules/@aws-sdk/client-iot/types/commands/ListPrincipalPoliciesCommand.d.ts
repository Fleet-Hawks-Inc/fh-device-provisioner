...
export declare type ListPrincipalPoliciesCommandInput = ListPrincipalPoliciesRequest;
export declare type ListPrincipalPoliciesCommandOutput = ListPrincipalPoliciesResponse & __MetadataBearer;
/**
 * @deprecated
 *
