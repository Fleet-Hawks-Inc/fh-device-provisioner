...
export declare type DetachPrincipalPolicyCommandInput = DetachPrincipalPolicyRequest;
export declare type DetachPrincipalPolicyCommandOutput = __MetadataBearer;
/**
 * @deprecated
 *
