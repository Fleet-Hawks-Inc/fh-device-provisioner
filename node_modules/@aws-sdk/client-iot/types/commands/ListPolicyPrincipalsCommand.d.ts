...
export declare type ListPolicyPrincipalsCommandInput = ListPolicyPrincipalsRequest;
export declare type ListPolicyPrincipalsCommandOutput = ListPolicyPrincipalsResponse & __MetadataBearer;
/**
 * @deprecated
 *
